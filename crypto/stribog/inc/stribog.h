...
private:
	...
	const uint8_t Lmatrix[64] = {

	    0x8e, 0x20, 0xfa, 0xa7, 0x2b, 0xa0, 0xb4, 0x70,
	    0x47, 0x1e, 0xbd, 0x8c, 0x3d, 0xda, 0xf8, 0x3f,
	    0xd1, 0x8c, 0xc4, 0xa9, 0xb2, 0x0f, 0x1a, 0x22,
	    0x03, 0xfe, 0x55, 0x87, 0x90, 0x7a, 0xf6, 0xc2,
	    0x6a, 0xb5, 0x8a, 0xa3, 0x2f, 0xb4, 0x7c, 0x67,
	    0x21, 0xb5, 0x06, 0x02, 0xf1, 0x3d, 0xd4, 0xf2,
	    0x16, 0xcd, 0xa1, 0x13, 0xa3, 0x2c, 0x48, 0x3a,
	    0xdf, 0x44, 0x9c, 0xa9, 0x29, 0x9a, 0x05, 0x96
...
public:
	...
	//X-function
	std::vector<uint8_t> stribogX(const std::vector<uint8_t> input1,
	...
	//modulo addition
	std::vector<uint8_t> add(std::vector<uint8_t> num1, std::vector<uint8_t> num2);


	//S-function
	std::vector<uint8_t> stribogS(const std::vector<uint8_t> &input);

	//P-function
	std::vector<uint8_t> stribogP(const std::vector<uint8_t> &input);

	//L-function
	std::vector<uint8_t> stribogL(const std::vector<uint8_t> &input);

	//std::vector<uint8_t> LL(const std::vector<uint8_t>& state);

	//std::vector<uint8_t> L_transform(const std::vector<uint8_t>& input);

	//getting Gn compression function
	std::vector<uint8_t> stribogG(std::vector<uint8_t> N, std::vector<uint8_t> h, std::vector<uint8_t> msg);

	//getting round keys function
	std::vector<uint8_t> stribogGetKeys(std::vector<uint8_t> key, int roundNum);


	//E-function
	std::vector<uint8_t> stribogE(std::vector<uint8_t> key, std::vector<uint8_t> state);

	//getting hash function
	std::vector<uint8_t> stribogGetHash(std::vector<uint8_t> msg, int msgLength);
